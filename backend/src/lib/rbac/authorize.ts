...
export function authorize(
 ...
 if (!user) {
  ...
  // 1. Check if user exists and has permission role
  ...
  // 3. Check membership status if in community context
